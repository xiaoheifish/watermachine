...
public class HttpsUtil extends DefaultHttpClient {
    ...
    // please replace the SELFCERTPATH/SELFCERTPWD/TRUSTCAPATH according to the
    // actual situation when you use the demo.
    ...
    // Where the TRUSTCAPWD is not the password for the CA certificate, but the
    // password for the jks certificate repository
    // the CA certificate itself does not contain a private key and therefore no
    // password
    ...
    public String doPostFormUrlEncodedForString(String url,
    ...
    public String doPutJsonForString(String url, Map<String, String> headerMap,
                                     String content) {
    ...
    public String doGetWithParasForString(String url,
                                          Map<String, String> queryParams, Map<String, String> headerMap)
            throws Exception {
    ...
    public String doDeleteForString(String url, Map<String, String> headerMap) {
