...
//watermachinein extend
iSlider.prototype.extend = function(watermachinein){
    var fn = iSlider.prototype;
    Object.keys(watermachinein).forEach(function(property) {
        Object.defineProperty(fn, property, Object.getOwnPropertyDescriptor( watermachinein, property ) );
    })
}