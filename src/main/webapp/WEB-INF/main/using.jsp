...
<span id="chwarnningtext">取水阀门将在<span style="color: rgb(230, 67, 64);">取水结束</span>或<span id="lefttime" style="color: rgb(230, 67, 64);">${lefttime}</span>s后关闭，<br>请您尽快取水，使用过程中请注意节约用水！</span>
