...
<input type="submit" value="取消" class="idbutton" id="cancle" onclick="closenumber()" style="left: 0;border-right: 0.5px solid rgb(136, 136, 136);color: rgb(136, 136, 136);z-index: -1;">
<input type="submit" value="确认" class="idbutton" id="login" onclick="login()" style="border-left: 0.5px solid rgb(136, 136, 136);">
</div>
</div>
...
<!-- 菜单-我的账户 -->
<div id="menu">
<div style="margin-bottom: 1rem;width: 100%; text-align: right;margin-top: -0.5rem;"><button onclick="closemenu();" id="closemenu" class="closemenu"><img style="width: 0.4rem" src="/watermachine/static/pic/back.png">&nbsp;<span id="closemenutext">关闭</span></button></div>
...
<button id="record" onclick="openrecordbox();" class="menu_1"><img style="width: 0.7rem"  src="/watermachine/static/pic/record.png"/>&nbsp;&nbsp;&nbsp;&nbsp;取水记录</button>

<button id="wallet" onclick="openwalletbox();" class="menu_1"><img style="width: 0.7rem" src="/watermachine/static/pic/wallet.png"/>&nbsp;&nbsp;&nbsp;&nbsp;我的钱包</button>

<button id="invite" onclick="openinvitationbox();" class="menu_1"><img style="width: 0.7rem" src="/watermachine/static/pic/invite.png"/>&nbsp;&nbsp;&nbsp;&nbsp;邀请好友</button>

<button id="service" onclick="openservicebox();" class="menu_1"><img style="width: 0.7rem" src="/watermachine/static/pic/service.png"/>&nbsp;&nbsp;&nbsp;&nbsp;我的客服</button>
